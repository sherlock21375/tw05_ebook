						...
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<div class="list-group">
									...
									<a class="list-group-item active">修改文章</a>
								</div>
						</div>
					</div>
					<div class="col-md-10">
							...
							<div class="panel-body">
								<form method="post" action="article.modify.handle.php" class="form-horizontal">
									<div class="form-group">
										<label for="article-id" class="col-sm-2 control-label">编号</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="article-id" placeholder="ID" name="id" value="<?php echo $data['id'];?>">
										</div>
									</div>
									<input type="hidden" name="id_before" value="<?php echo $data['id'];?>">
									<div class="form-group">
										<label for="article-title" class="col-sm-2 control-label">文件名称</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="article-name" placeholder="FileName" name="name" value="<?php echo $data['name'];?>">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="article" id="article" cols="30" rows="15" class="form-control"><?php echo $data['article'];?></textarea>
										</div>
									</div>
									<div class="form-group">
